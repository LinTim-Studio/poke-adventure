...
void main() {
	...
	if (tc.x - 4 * blur > 0) {
		...
		sum += texture2D(tex0, vec2(tc.x + 1.0*blur, tc.y)) * (0.15 + 0.1);
		sum += texture2D(tex0, vec2(tc.x + 2.0*blur, tc.y)) * (0.12 + 0.09);
		sum += texture2D(tex0, vec2(tc.x + 3.0*blur, tc.y)) * (0.09 + 0.06);
		sum += texture2D(tex0, vec2(tc.x + 4.0*blur, tc.y)) * (0.05 + 0.04);
